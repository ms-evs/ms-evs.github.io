...
- Real-SpectralFace (~1.5G) : Available on-demand ([Contact maintainer](mailto:saad.himmi@sony.com))
...
- Real-SpectralFace (<1G) : Available on-demand ([Contact maintainer](mailto:saad.himmi@sony.com))
...
- Real-SpectralFace (A few MBs) : Available on-demand ([Contact maintainer](mailto:saad.himmi@sony.com))
